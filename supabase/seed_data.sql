...
('静夜思', '床前明月光，疑是地上霜。举头望明月，低头思故乡。', 
 ...
 (SELECT id FROM categories WHERE name = '唐诗' LIMIT 1), 
 '唐代', '{"思乡", "明月", "夜晚"}'),

('春晓', '春眠不觉晓，处处闻啼鸟。夜来风雨声，花落知多少。', 
 (SELECT id FROM authors WHERE name = '孟浩然' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '唐诗' LIMIT 1), 
 '唐代', '{"春天", "自然", "清晨"}'),

('登鹳雀楼', '白日依山尽，黄河入海流。欲穷千里目，更上一层楼。', 
 (SELECT id FROM authors WHERE name = '王之涣' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '唐诗' LIMIT 1), 
 '唐代', '{"登高", "壮丽", "哲理"}'),

('水调歌头·明月几时有', '明月几时有？把酒问青天。不知天上宫阙，今夕是何年。我欲乘风归去，又恐琼楼玉宇，高处不胜寒。起舞弄清影，何似在人间。', 
 (SELECT id FROM authors WHERE name = '苏轼' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '宋词' LIMIT 1), 
 '宋代', '{"中秋", "明月", "思念"}'),

('声声慢·寻寻觅觅', '寻寻觅觅，冷冷清清，凄凄惨惨戚戚。乍暖还寒时候，最难将息。三杯两盏淡酒，怎敌他、晚来风急？雁过也，正伤心，却是旧时相识。', 
 (SELECT id FROM authors WHERE name = '李清照' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '宋词' LIMIT 1), 
 '宋代', '{"忧愁", "思念", "秋天"}'),

('相思', '红豆生南国，春来发几枝。愿君多采撷，此物最相思。', 
 (SELECT id FROM authors WHERE name = '王维' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '爱情诗' LIMIT 1), 
 '唐代', '{"相思", "爱情", "红豆"}'),
...
('赋得古原草送别', '离离原上草，一岁一枯荣。野火烧不尽，春风吹又生。远芳侵古道，晴翠接荒城。又送王孙去，萋萋满别情。', 
 (SELECT id FROM authors WHERE name = '白居易' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '送别诗' LIMIT 1), 
 '唐代', '{"送别", "自然", "生命"}'),

('清明', '清明时节雨纷纷，路上行人欲断魂。借问酒家何处有？牧童遥指杏花村。', 
 (SELECT id FROM authors WHERE name = '杜牧' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '唐诗' LIMIT 1), 
 '唐代', '{"清明", "春天", "酒家"}'),

('无题', '相见时难别亦难，东风无力百花残。春蚕到死丝方尽，蜡炬成灰泪始干。', 
 (SELECT id FROM authors WHERE name = '李商隐' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '爱情诗' LIMIT 1), 
 '唐代', '{"爱情", "离别", "思念"}'),

('泊船瓜洲', '京口瓜洲一水间，钟山只隔数重山。春风又绿江南岸，明月何时照我还？', 
 (SELECT id FROM authors WHERE name = '王安石' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '唐诗' LIMIT 1), 
 '宋代', '{"思乡", "江南", "春天"}'),

('望庐山瀑布', '日照香炉生紫烟，遥看瀑布挂前川。飞流直下三千尺，疑是银河落九天。', 
 (SELECT id FROM authors WHERE name = '李白' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '山水田园' LIMIT 1), 
 '唐代', '{"瀑布", "自然", "壮丽"}'),

('江雪', '千山鸟飞绝，万径人踪灭。孤舟蓑笠翁，独钓寒江雪。', 
 (SELECT id FROM authors WHERE name = '柳宗元' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '山水田园' LIMIT 1), 
 '唐代', '{"冬天", "孤独", "自然"}'),

('游子吟', '慈母手中线，游子身上衣。临行密密缝，意恐迟迟归。谁言寸草心，报得三春晖。', 
 (SELECT id FROM authors WHERE name = '孟郊' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '唐诗' LIMIT 1), 
 '唐代', '{"母爱", "亲情", "感恩"}'),

('枫桥夜泊', '月落乌啼霜满天，江枫渔火对愁眠。姑苏城外寒山寺，夜半钟声到客船。', 
 (SELECT id FROM authors WHERE name = '张继' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '唐诗' LIMIT 1), 
 '唐代', '{"夜晚", "忧愁", "苏州"}'),
...
('出塞', '秦时明月汉时关，万里长征人未还。但使龙城飞将在，不教胡马度阴山。', 
 (SELECT id FROM authors WHERE name = '王昌龄' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '边塞诗' LIMIT 1), 
 '唐代', '{"边塞", "战争", "爱国"}'),

('悯农', '锄禾日当午，汗滴禾下土。谁知盘中餐，粒粒皆辛苦。', 
 (SELECT id FROM authors WHERE name = '李绅' LIMIT 1), 
 (SELECT id FROM categories WHERE name = '唐诗' LIMIT 1), 
 '唐代', '{"农民", "劳动", "珍惜"}'),
